...
describe("setInto", () => {
  ...
  describe("objects", () => {
    const updateName = setInto("user.config['name']", "Marco");
    it("should create a value if it does not exist and the parent prop is an object", () => {
      const obj = {};
      updateName(obj);
    ...
    it("should update a value if it does not exist and the parent prop is an object", () => {
  ...
  describe("arrays", () => {
    it("should create a value if it does not exist and the parent prop is an array", () => {
      const obj = {};
    ...
    it("should update a value if it does not exist and the parent prop is an array", () => {
      const obj = {};
      setInto("orgs.[3].name", "Fake company")(obj);
